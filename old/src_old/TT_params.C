...
void TT_params::Init_valgrind()
{
    ...
    f_filename="events_memtest.root";
...
void TT_params::Set_flux_mode(Int_t flux_mode)
{
  ...
  f_N_flux_bins=f_flux_histo->GetNbinsX()+2;
  f_flux_bins_on=new Bool_t[f_N_flux_bins];
...
////////////////////////////////////////////////////////////////////////
void TT_params::Upper(Double_t g[4][4],Double_t a_lower[4],Double_t a_upper[4]){
  //g is diagonal
