...
TT_generator::TT_generator(TT_params *params,TT_nucleus *nucleus)
{
  ...
  f_N_flux_bins=f_params->f_N_flux_bins;
  ...
  for (Int_t iProcess=0;iProcess<f_N_Processes;iProcess++) {
    f_accepted_points[iProcess]=new Long64_t  [f_N_flux_bins];
    f_total_points   [iProcess]=new Long64_t  [f_N_flux_bins];
    f_rate_est       [iProcess]=new Double_t  [f_N_flux_bins];
    f_rate_err       [iProcess]=new Double_t  [f_N_flux_bins];
    f_drawer         [iProcess]=new TT_drawer*[f_N_flux_bins];
