Int_t compare_plots(Int_t mode=0) {
  ...
  if (mode==1) {
    ...
    TFile f_TK("~elaird/ccqe/xs_ted/single_n/katori/single.root");
    TFile f_single_mod("~elaird/ccqe/xs_ted/single_mod.root");
    TFile f_single("~elaird/ccqe/xs_ted/single.root");
    gROOT->cd();
